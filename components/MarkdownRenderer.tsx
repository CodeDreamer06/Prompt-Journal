    ...
    <div className={`${baseProseClasses} ${className}`}>
      <ReactMarkdown
        ...
        components={{
          ...
          th: ({ children }) => (
            <th className="px-4 py-3 text-left text-xs font-medium text-gray-900 dark:text-gray-100 tracking-wider border-b border-gray-200/30 dark:border-gray-700/30">
              {children}
            </th>
          ),
          td: ({ children }) => (
